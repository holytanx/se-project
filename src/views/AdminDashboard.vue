<template>
  <v-container>
    <v-dialog v-model="view" persistent max-width="1200px">
      <v-card>
        <v-card-title>
            ...
            <template v-slot:top>
              <v-toolbar flat color="white">
                <v-card-title class="headline font-weight-bold">
                  โครงการหลัก<v-card-subtitle>(กำลังดำเนินการ)</v-card-subtitle>
                  <v-spacer></v-spacer>
                </v-card-title>
                ...
                <v-dialog v-model="dialog" max-width="600px">
                  <template v-slot:activator="{ on }">
                    <v-btn outlined color="#c43926" rounded dark class="mb-2" v-on="on"
                      >เพิ่มโครงการหลัก</v-btn
                    >
                  </template>
                  <v-card>
                    <v-card-text>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn color="red" text @click="dialog = false"
                        >ยกเลิก</v-btn
                      >
                      <v-btn color="success" text @click="add_project"
                        >เพิ่ม</v-btn
                      >
                    </v-card-actions>
                  </v-card>
...
export default {
  ...
  methods: {
    ...
    sub_filterdeptName(project) {
      if (project == "0" || parseInt(project) == 0) return "ee_subproject";
      else if (project == "1" || parseInt(project) == 1) return "ce_subproject";
      else if (project == "2" || parseInt(project) == 2) return "ae_subproject";
      else if (project == "3" || parseInt(project) == 3) return "ie_subproject";
      else if (project == "4" || parseInt(project) == 4) return "me_subproject";
      else if (project == "5" || parseInt(project) == 5)
